...
for epoch_size in range(100, 1100, 100):
    ...
    csv_logger = CSVLogger(f'result/train/csv/train_epoch{epoch_size}_resnet_logs.csv', append=False)
    ...
    ResNet_model.save(f'model/train_model_epoch{epoch_size}_resnet')
